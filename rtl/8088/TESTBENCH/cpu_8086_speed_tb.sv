...
module cpu_8086_speed_tb;
    ...
    RAM ram (
        ...
        .ems_b3(1'b0), .ems_b4(1'b0), .umb_enabled(1'b1),
        .bios_protect_flag(3'b000), .wait_count_clk_en(cpu_ce_negedge),
        .ram_read_wait_cycle(ram_read_wait_cycle),
        .ram_write_wait_cycle(ram_write_wait_cycle),
...
`endif
    ...
    task automatic run_live_transition(input logic [1:0] from_profile,
        ...
        begin
            ...
            // in PCXT-EGA.sv, and continue without resetting the CPU or queue.
            guard = 0;
